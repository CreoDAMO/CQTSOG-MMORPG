 ...
 */
export declare function formatReserve({ reserve, currentTimestamp, }: FormatReserveRequest): FormatReserveResponse;
 ...
 */
export declare function formatReserveUSD({ reserve, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, }: FormatReserveUSDRequest): FormatReserveUSDResponse;
...
export declare function formatReserves<T extends ReserveDataWithPrice>({ reserves, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, }: FormatReservesUSDRequest<T>): (T & FormatReserveUSDResponse)[];
...
export declare function formatReservesAndIncentives<T extends ReserveDataWithPrice>({ reserves, currentTimestamp, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, reserveIncentives, }: FormatReservesAndIncentivesUSDRequest<T>): Array<FormatReserveUSDResponse & T & Partial<CalculateReserveIncentivesResponse>>;
