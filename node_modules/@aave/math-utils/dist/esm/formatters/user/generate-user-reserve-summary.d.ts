...
export declare function generateUserReserveSummary<T extends FormatReserveUSDResponse = FormatReserveUSDResponse>({ userReserve, marketReferencePriceInUsdNormalized, marketReferenceCurrencyDecimals, currentTimestamp, }: UserReserveSummaryRequest<T>): UserReserveSummaryResponse<T>;
