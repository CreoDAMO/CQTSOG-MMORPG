...
export declare function generateRawUserSummary({ userReserves, marketReferencePriceInUsd, marketReferenceCurrencyDecimals, userEmodeCategoryId, }: RawUserSummaryRequest): RawUserSummaryResponse;
