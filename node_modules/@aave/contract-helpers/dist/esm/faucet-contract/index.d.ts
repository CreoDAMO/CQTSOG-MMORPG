...
export declare class FaucetService extends BaseService<IFaucet> implements FaucetInterface {
    ...
    mint({ userAddress, reserve, tokenSymbol }: FaucetParamsType): EthereumTransactionTypeExtended[];
}
