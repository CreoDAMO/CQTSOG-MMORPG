...
import { GetHumanizedUserPermissionsResponse, GetUserPermissionsResponse } from './types/PermissionManagerTypes';
...
export declare class PermissionManager {
    ...
    getHumanizedUserPermissions(user: string): Promise<GetHumanizedUserPermissionsResponse>;
}
