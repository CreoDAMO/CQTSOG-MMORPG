...
export declare class Pool extends BaseService<IPool> implements PoolInterface {
    ...
    migrateV3({ migrator, borrowedAssets, borrowedAmounts, interestRatesModes, user, suppliedPositions, borrowedPositions, permits, }: LPV3MigrationParamsType): Promise<PopulatedTransaction>;
}
