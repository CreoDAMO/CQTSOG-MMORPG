...
})(ProposalV3State || (ProposalV3State = {}));
export class GovernanceDataHelperService {
    constructor(governanceDataHelperContractAddress, provider) {
        this._contract = GovernanceDataHelper__factory.connect(governanceDataHelperContractAddress, provider);
    }
