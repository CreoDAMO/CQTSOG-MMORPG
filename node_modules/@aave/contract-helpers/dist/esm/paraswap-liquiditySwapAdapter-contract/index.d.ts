...
import { EthereumTransactionTypeExtended, PermitSignature, tEthereumAddress } from '../commons/types';
...
export declare class LiquiditySwapAdapterService extends BaseService<IParaSwapLiquiditySwapAdapter> implements LiquiditySwapAdapterInterface {
    readonly liquiditySwapAdapterAddress: string;
    constructor(provider: providers.Provider, swapCollateralAdapterAddress?: string);
