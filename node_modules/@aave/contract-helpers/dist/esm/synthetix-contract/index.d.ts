...
export declare class SynthetixService extends BaseService<ISynthetix> implements SynthetixInterface {
    constructor(provider: providers.Provider);
    synthetixValidation({ user, reserve, amount, }: SynthetixValidationType): Promise<boolean>;
}
