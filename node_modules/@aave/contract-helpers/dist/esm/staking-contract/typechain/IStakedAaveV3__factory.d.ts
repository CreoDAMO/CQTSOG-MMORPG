...
export declare class StakedAaveV3__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): StakedAaveV3;
}
//# sourceMappingURL=IStakedAaveV3__factory.d.ts.map