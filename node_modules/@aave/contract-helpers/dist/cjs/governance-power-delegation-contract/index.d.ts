...
import { ENS, EthereumTransactionTypeExtended, tEthereumAddress } from '../commons/types';
...
export declare class GovernancePowerDelegationTokenService extends BaseService<IGovernancePowerDelegationToken> implements GovernancePowerDelegationToken {
    ...
    getPowerCurrent({ user, delegationType, governanceToken }: GovGetPowerCurrent): Promise<string>;
    getPowerAtBlock({ user, blockNumber, delegationType, governanceToken }: GovGetPowerAtBlock): Promise<string>;
