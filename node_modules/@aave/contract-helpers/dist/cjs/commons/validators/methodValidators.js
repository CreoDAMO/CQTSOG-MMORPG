...
exports.V3MigratorValidator = exports.StakeUiDataProviderValidator = exports.GovDelegationValidator = exports.GovValidator = exports.GovHelperValidator = exports.WETHValidator = exports.FaucetValidator = exports.SignStakingValidator = exports.StakingValidator = exports.RepayWithCollateralValidator = exports.WithdrawAndSwitchValidator = exports.LiquiditySwapValidator = exports.ERC20Validator = exports.SynthetixValidator = exports.DebtTokenValidator = exports.IncentivesValidator = exports.UiIncentiveDataProviderValidator = exports.LPValidatorV3 = exports.L2PValidator = exports.LPValidator = exports.LPSwapCollateralValidatorV3 = exports.LPRepayWithCollateralValidatorV3 = exports.LPSwapCollateralValidator = exports.LPRepayWithCollateralValidator = exports.LPFlashLiquidationValidatorV3 = exports.LPFlashLiquidationValidator = void 0;
...
function WithdrawAndSwitchValidator(target, propertyName, descriptor) {
    const method = descriptor.value;
    descriptor.value = function () {
        // @ts-expect-error todo: check why this ignore is needed
        if (!ethers_1.utils.isAddress(this.withdrawAndSwitchAdapterAddress)) {
            console.error(`[WithdrawAndSwitchValidator] You need to pass valid addresses`);
            return [];
        }
        (0, validations_1.isEthAddressValidator)(target, propertyName, arguments);
        (0, validations_1.amountGtThan0Validator)(target, propertyName, arguments);
...
exports.WithdrawAndSwitchValidator = WithdrawAndSwitchValidator;
...
exports.StakeUiDataProviderValidator = StakeUiDataProviderValidator;
...
exports.V3MigratorValidator = V3MigratorValidator;
