...
export declare class IncentivesController extends BaseService<IAaveIncentivesController> implements IncentivesControllerInterface {
    constructor(provider: providers.Provider);
    claimRewards({ user, assets, to, incentivesControllerAddress }: ClaimRewardsMethodType): EthereumTransactionTypeExtended[];
}
