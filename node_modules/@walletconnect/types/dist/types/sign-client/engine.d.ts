...
export interface EnginePrivate {
    ...
    onSessionAuthenticateRequest(topic: string, payload: JsonRpcRequest<JsonRpcTypes.RequestParams["wc_sessionAuthenticate"]>): Promise<void>;
...
export declare abstract class IEngine {
    ...
    abstract authenticate: (params: AuthTypes.SessionAuthenticateParams) => Promise<EngineTypes.SessionAuthenticateResponsePromise>;
