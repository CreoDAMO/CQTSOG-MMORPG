...
install-blockchain-dependencies:
	...
	@cd $(APP_NAME) && npm install web3 ethers @metamask/detect-provider @uniswap/sdk @ethersproject/address @ethersproject/abi @ethersproject/providers @ethersproject/contracts @ethersproject/hardware-wallets @aave/contract-helpers reflect-metadata --legacy-peer-deps
